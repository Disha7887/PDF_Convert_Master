...
- [Watermark/overlay text fit](watermark-text-fit.md) — size overlay text via length-based aspect (like Sign tool's signAspect); do NOT measure off-screen (races web font load → overflow); adjustsFontSizeToFit is web-unsupported.
