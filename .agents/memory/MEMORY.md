...
- [Watermark/overlay text fit](watermark-text-fit.md) — fit single-line overlay text by MEASURING glyph width (hidden Text + onLayout), not a length guess; adjustsFontSizeToFit is web-unsupported.
