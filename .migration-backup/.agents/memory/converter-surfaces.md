...
`"compress-image"`; (2) ALL PDF-Editor tool ids now HAVE card/upload
animations (`edit-pdf`,`crop-pdf`,`sign-pdf`,`watermark-pdf`,`add-image-pdf`,
`delete-pages-pdf`,`ocr-pdf`) — none fall back to lucide anymore;
